...
extern "C" {
 ...
 extern void PPIDD_MA_init(int64_t *dtype, int64_t *stack, int64_t *heap, int *ok);
 ...
 extern void PPIDD_Iprobe(int64_t *tag,int64_t *source,int *ok);
 ...
 extern void PPIDD_Create_irreg(char *name,int64_t *lenin,int64_t *nchunk,int64_t *datatype,int64_t *storetype,int64_t *handle,int *ok);
 extern void PPIDD_Create(char *name,int64_t *lentot, int64_t *datatype, int64_t *storetype, int64_t *handle, int *ok);
 extern void PPIDD_Destroy(int64_t *handle,int *ok);
 extern void PPIDD_Distrib(int64_t *handle,int64_t *rank,int64_t *ilo,int64_t *ihi,int *ok);
 extern void PPIDD_Location(int64_t *handle,int64_t *ilo,int64_t *ihi,int64_t *map,int64_t *proclist,int64_t *np,int *ok);
 extern void PPIDD_Get(int64_t *handle,int64_t *ilo,int64_t *ihi,void *buff,int *ok);
 extern void PPIDD_Put(int64_t *handle,int64_t *ilo,int64_t *ihi,void *buff,int *ok);
 extern void PPIDD_Acc(int64_t *handle,int64_t *ilo,int64_t *ihi,void *buff,void *fac,int *ok);
 ...
 extern void PPIDD_Zero(int64_t *handle,int *ok);
 ...
 extern void PPIDD_Create_mutexes(int64_t *storetype,int64_t *number,int *ok);
