...
extern "C" {
 ...
 extern int  PPIDD_MA_init(int64_t *dtype, int64_t *stack, int64_t *heap);
 ...
 extern int  PPIDD_Create_irreg(char *name,int64_t *lenin,int64_t *nchunk,int64_t *datatype,int64_t *storetype,int64_t *handle);
 extern int  PPIDD_Create(char *name,int64_t *lentot, int64_t *datatype, int64_t *storetype, int64_t *handle);
