...
#ifndef LSEEK
#if (defined(__hpux) && !defined(_I8_)) || (defined(sgi) && (_MIPS_ISA > 2)) || defined(sun) || defined(_USE_LARGEFILE64)
#define LSEEK 		lseek64
#else
#define LSEEK		lseek
#endif
...
#elif (defined(__hpux) && !defined(_I8_)) || (defined(sgi) && (_MIPS_ISA > 2)) || defined(sun)
#define OFFSET 		off64_t
#else
#define OFFSET		off_t
#endif
...
#ifndef OPEN
#if (defined(__hpux) && !defined(_I8_)) || defined(sun) || defined(_USE_LARGEFILE64)
#define OPEN 		open64
#else
#define OPEN 		open
#endif
